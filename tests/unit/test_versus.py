...
#
# from pqhelper.versus import get_choice_summaries
...
#
#     def test_get_choice_summaries_produces_3_summaries(self):
#         summaries = get_choice_summaries(self.board_string_3_valid_swaps)
#         print summaries
